...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container px-10 sm:px-20 relative z-10">
        <h1 className="text-[30px] md:text-[40px] sm:text-[32px] font-extrabold text-white leading-tight md:mb-8 mb-6">
        ...
        <div className="max-w-3xl">
          ...
          <div className="inline-block py-1 md:mb-6 mb-3">
            <span className="text-blue-200 text-[12px] md:text-[14px] font-semibold tracking-wider uppercase">Líderes en transporte pesado</span>
          </div>
          <h1 className=" text-[15px] md:text-[20px] sm:text-[16px]  font-extrabold text-white leading-tight md:mb-6 my-5">
            SEGURIDAD, CALIDAD Y <span className="text-blue-400">PROFESIONALISMO</span>
          </h1>
          <p className="text-[13px] md:text-[16px] sm:text-[16px] text-blue-100 md:mb-10 mb-6 max-w-1xl leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a 
              href="#servicios" 
              className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md md:px-8 md:py-4 px-3 py-2  rounded-lg font-bold text-md text-[16px] border border-white/20 transition-all text-center"
            >
              Nuestros Servicios
            </a>
          </div>
